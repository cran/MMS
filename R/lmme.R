lmme=function(data,Y,z,grp,step,showit)
{
...
# fin alg51bolm
#########################
out=list(data=list(X=data,Y=Y,z=z,grp=grp),beta=beta_hat,sigma_u=sigma_u,sigma_e=sigma_e,fitted.values=yhatt,it=compteur_ijk,converge=converge,call=match.call())
